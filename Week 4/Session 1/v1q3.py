...
# trending based on how frequently they are adopted by brands. You want to identify 
# which materials and practices are trending. A material or practice is considered 
# "trending" if it appears in the dataset more than once.
