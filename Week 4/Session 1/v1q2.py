...
# You need to track which materials are used by various brands and count how many times each material appears across all brands. This will help identify the most commonly used eco-friendly materials.
...
def count_material_usage(brands): #O(nm)
    counts = {}
    for brand in brands:
        for material in brand["materials"]:
            counts[material] = 1 + counts.get(material, 0)
    return counts
