#question 7
# Captain Blackbeard has two treasure maps represented by two strings of 
# the same length map1 and map2. In one step, you can choose any character 
# of map2 and replace it with another character.
