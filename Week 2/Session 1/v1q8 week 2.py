...
# [pirateID, time] indicates that the pirate with pirateID performed an action 
# at the minute time.

# Multiple pirates can perform actions simultaneously, and a single pirate 
...
# for each j (1 <= j <= k), answer[j] is the number of pirates whose PAM 
# equals j.
